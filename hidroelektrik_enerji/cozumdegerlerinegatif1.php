    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $query="SELECT kurulum_gucune_gore_santral_vij_degerleri.santral_adi,  POWER(kurulum_gucune_gore_santral_vij_degerleri.kurulum_gucune_gore_santral_vij - (SELECT min(kurulum_gucune_gore_santral_vij_degerleri.kurulum_gucune_gore_santral_vij) as minumum from kurulum_gucune_gore_santral_vij_degerleri ),2) AS 'kurulum_gucu_A_negatif'
          ...
          while($data=mysqli_fetch_array($res)){
            ...
            $kurulum_gucu_A_negatif=$data['kurulum_gucu_A_negatif'];
            ?>
            ['<?php echo $santral_adi; ?>' , <?php echo $kurulum_gucu_A_negatif; ?>],
            <?php
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          while($data=mysqli_fetch_array($res)){
            $santral_adi=$data['santral_adi'];
            $yillik_enerji_A_negatif=$data['yillik_enerji_A_negatif'];
            ?>
            ['<?php echo $santral_adi; ?>' , <?php echo $yillik_enerji_A_negatif; ?>],
            <?php
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          while($data=mysqli_fetch_array($res)){
            $santral_adi=$data['santral_adi'];
            $hidr_dusu_A_negatif=$data['hidr_dusu_A_negatif'];
            ?>
            ['<?php echo $santral_adi; ?>' , <?php echo $hidr_dusu_A_negatif; ?>],
            <?php
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $query="SELECT dep_kapasitesi_alanina_gore_santral_vij_degerleri.santral_adi,  POWER(dep_kapasitesi_alanina_gore_santral_vij_degerleri.dep_kapasitesi_alanina_gore_santral_vij_degerleri - (SELECT min(dep_kapasitesi_alanina_gore_santral_vij_degerleri.dep_kapasitesi_alanina_gore_santral_vij_degerleri) as minumum from dep_kapasitesi_alanina_gore_santral_vij_degerleri ),2) AS 'depo_kapasite_A_negatif'
          ...
          while($data=mysqli_fetch_array($res)){
            $santral_adi=$data['santral_adi'];
            $depo_kapasite_A_negatif=$data['depo_kapasite_A_negatif'];
            ?>
            ['<?php echo $santral_adi; ?>' , <?php echo $depo_kapasite_A_negatif; ?>],
            <?php
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
          $query="SELECT su_seviyesine_gore_santral_vij_degerleri.santral_adi,  POWER(su_seviyesine_gore_santral_vij_degerleri.su_seviyesine_gore_santral_vij_degerleri - (SELECT min(su_seviyesine_gore_santral_vij_degerleri.su_seviyesine_gore_santral_vij_degerleri) as minumum from su_seviyesine_gore_santral_vij_degerleri ),2) AS 'su_sayisi_A_negatif'
          ...
          while($data=mysqli_fetch_array($res)){
            $santral_adi=$data['santral_adi'];
            $su_sayisi_A_negatif=$data['su_sayisi_A_negatif'];
            ?>
            ['<?php echo $santral_adi; ?>' , <?php echo $su_sayisi_A_negatif; ?>],
            <?php
        ...
        var options = {
          title: 'Su Seviyesi kriterine göre A- değeri',
          hAxis: {title: 'Alternatifler',minValue: 0, maxValue: 3},
          vAxis: {title: 'Su Seviyesi',minValue: 0, maxValue: 0.03},
          legend: { position: 'center' },
          height:500,
          width:900,
          pointShape: 'circle',
